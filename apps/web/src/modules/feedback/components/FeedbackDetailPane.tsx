...
import type { FeedbackItem, FeedbackNote, FeedbackActivity, AdminUser, FeedbackStatus } from "../api";
import { STATUS_TONE, STATUS_LABELS, CATEGORY_LABELS, fmtDate, relativeTime } from "../lib/feedback-ui";
						...
						{notes.length > 0 ? (
							<ul className="space-y-2 mb-3">
								{notes.map((n) => (
									<li
										key={n.id}
										className="bg-surface-elevated/60 rounded-lg px-3 py-2.5"
									>
